...
namespace DVLD.Applications
{
    public partial class fmManageLocalDrivingLicense : Form
    {
        ...
        {
            DataView dvLocalDrivingLicenses = LocalDrivingLicenses.DefaultView;
            dvLocalDrivingLicenses.RowFilter = $"Class ='{Value}'";
        }
       ...
       private void onScheduleClick(long LDLID,short TestType)
       {
        ...
        {
            onScheduleClick((long)dgLocalDrivingLicenses.CurrentRow.Cells[0].Value, 1);
        }

        private void tsWritten_Click(object sender, EventArgs e)
        {
            onScheduleClick((long)dgLocalDrivingLicenses.CurrentRow.Cells[0].Value, 2);
        }

        private void tsPractical_Click(object sender, EventArgs e)
        {
            onScheduleClick((long)dgLocalDrivingLicenses.CurrentRow.Cells[0].Value, 3);
        }
        ...
        private void tsCancel_Click(object sender, EventArgs e)
        {
            ...
            clsLocalDrivingLicenseApplication.UpdateStatus(ApplicationID, clsLocalDrivingLicenseApplication.enStatusID.Canceled);
            _LoadLocalDrivingLicenses();
        }
        ...
        {
            fmDrivingLicenseHistory fm = new fmDrivingLicenseHistory((long)dgLocalDrivingLicenses.CurrentRow.Cells[1].Value);
            fm.ShowDialog();
        }
    }
}
